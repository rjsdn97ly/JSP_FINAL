...
%>
               ...
               <tbody>
                  <tr>
                     <th scope="row">아이디</th>
                     <td colspan="3"><%=session.getAttribute("id")%></td>
                  </tr>
                  <tr>
                     <th scope="row">비밀번호</th>
                     <td colspan="3"><%=session.getAttribute("pw")%></td>
                  </tr>
                  <tr>
                     <th scope="row">휴대전화</th>
                     <td colspan="3"><%=session.getAttribute("tel")%></td>
                  </tr>
                     <tr>
                     <th scope="row">주소</th>
                  ...
                  <tr>
                     <th scope="row">이메일</th>
                     <td colspan="3"><%=session.getAttribute("email")%></td>
                  </tr>
...
<!-- -------------------------------------정보수정 버튼---------------------------------------- -->
   ...
   <button type="button" class="btn btn-outline-dark btn-block"  onClick ="location.href='update.jsp'">정보 수정</button>
         <!-- 하단 버튼 끝  -->
   </div>
<!-- -------------------------------------/정보수정 버튼---------------------------------------- -->
      </div>
