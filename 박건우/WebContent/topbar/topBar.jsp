			...
			<ul class="navbar-nav px-5">
				<li class="nav-item dropdown active">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="/마이페이지/마이페이지%20화면/main.jsp">마이페이지</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="../LOGIN/main.jsp">로그인</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="..마이페이지/장바구니/main.jsp">장바구니</a>
						<div class="dropdown-divider"></div>
