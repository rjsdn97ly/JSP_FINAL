...
<body>
	<div id="logreg-forms">
		...
		<form class="form-signin" action="loginPro2.jsp" method="post">
			<h1 class="h3 mb-3 font-weight-normal" style="text-align: center" id="title">Login</h1>

			<input name="id" type="id" id="inputId" class="form-control" placeholder="아이디를 입력하세요" required="" autofocus="">
			<input name="pw" type="password" id="inputPassword" class="form-control" placeholder="비밀번호를 입력하세요" required="">
			...
			<button class="btn btn-block" type="submit" id="btn-signin">
				<i class="fas fa-sign-in-alt"></i><b>로그인</b>
			</button>
			...
			<button class="btn btn-block" type="button" id="btn-signup">
				<i class="fas fa-user-plus"></i><b>회원가입</b>
			</button>
		</form>
