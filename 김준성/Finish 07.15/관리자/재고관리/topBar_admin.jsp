			...
			<ul class="navbar-nav px-5">
				<li class="nav-item dropdown active">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="/Finish/관리자/회원관리/main.jsp">회원관리</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="/Finish/관리자/재고관리/main.jsp">재고관리</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="/Finish/관리자/관리자 메인/main.jsp">메인화면</a>
						<div class="dropdown-divider"></div>
				</li>
			</ul>
		</div>
