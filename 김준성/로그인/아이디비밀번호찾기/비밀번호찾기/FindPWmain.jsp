...
<body>
	...
	<!---------------------------------------------------- /상단 텝바 ----------------------------------------------------------->
		...
		<div class="container mt-2 d-flex ">
			...
			<div class="p-2 ml-auto"><button onclick="location.href='이메일인증/main.jsp' " class="btn btn-block" type="button" id="btn-signup"> 이동</button></div>
			</div>
			</div>
				<div class="border mb-4 pb-2 m-3">
			<div class="container mt-2 d-flex ">
			<h3 class="p-2">휴대폰 인증</h3>
			<div class="p-2 ml-auto"><button onclick="location.href='휴대폰인증/main.jsp' " class="btn btn-block" type="button" id="btn-signup">이동</button></div>
			</div>
			</div>
