            ...
            <table class="table table-striped"
                  ...
                  <tr>
					&nbsp
                     <th colspan="2"
                        ...
                        style="background-color: #eeeeee; text-align: center;  ">리뷰작성</th>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><input type="text" class="form-control" placeholder="화장품 이름" name="bbsTitle" maxlength="50"/></td>
                  ...
                  <tr>
                     ...
                     <td><input type="text" class="form-control" placeholder="작성자" name="bbsTitle" maxlength="50"/></td>

                  </tr>
                  
                   <tr>

                     <td><input type="file" class="form-control" placeholder="첨부파일" name="bbsfile" maxlength="50"/></td>
